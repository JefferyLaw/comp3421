<?php
session_start(); // Start session for CSRF token and redirects
    ...
    <div class="container">
        <div class="auth-form">
            ...
            <div class="welcome-text">
                Join Task Master to organize your tasks and boost productivity!
            </div>
            <hr class="hline">
            <h2 class="register">Register</h2>
            <?php if (!empty($message)): ?>
                <p class="message <?php echo strpos($message, 'Error') !== false || strpos($message, 'taken') !== false ? 'error' : 'success'; ?>">
                    <?php echo $message; ?>
                </p>
            <?php endif; ?>
